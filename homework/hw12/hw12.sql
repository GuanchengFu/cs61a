...
CREATE TABLE siblings AS
  SELECT a.child as sibling_1, b.child as sibling_2 from parents as a, parents as b
  where a.parent = b.parent
  and a.child < b.child;

-- Sentences about siblings that are the same size
CREATE TABLE sentences AS
  SELECT a.sibling_1 || " and " || a.sibling_2 || " are " || c.size || " siblings"
  from siblings as a, size_of_dogs as b, size_of_dogs as c
  where a.sibling_1 = b.name
  and a.sibling_2 = c.name
  and b.size = c.size;
